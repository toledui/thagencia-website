...
export function FloatingCTA() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-[9999] inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-2xl hover:scale-110 transition-transform duration-300"
    >
